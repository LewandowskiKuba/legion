    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-[#c0c0cc] mt-1">Ostatnie 20 badań zapisanych na serwerze</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="bg-[#1f1f25] border border-[#38383f] rounded-xl p-12 text-center">
          <Clock className="w-10 h-10 text-[#6b6b78] mx-auto mb-3" />
          <p className="text-[#c0c0cc] text-sm">Brak zapisanych badań</p>
          <p className="text-[#6b6b78] text-xs mt-1">Uruchom pierwsze badanie, aby zobaczyć historię</p>
        </div>
      ) : (
        <div className="space-y-3">
          {studies.map((study) => (
            <button
              ...
              className="w-full bg-[#1f1f25] border border-[#38383f] rounded-xl p-5 text-left hover:border-[#6366f1] transition-colors group"
            >
              <div className="flex items-center justify-between">
                ...
                <ChevronRight className="w-4 h-4 text-[#6b6b78] group-hover:text-[#6366f1] transition-colors ml-4 shrink-0" />
              </div>
            </button>
          ))}
        </div>
